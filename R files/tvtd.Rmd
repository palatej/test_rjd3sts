...
As usual, the regression variables are modelled by using constrats (for instance: #days-#sundays).
the coefficient follow a multivariate random walk. As for the usual regression, we put 
the constraint that the sum of the coefficents is 0 (which implies that one coefficient 
is derived from the others).

To be noted that fixed coefficients correspond to no innovation in the random walk.

Such time varying trading days can be plugged in any arepsresentation of the series.
