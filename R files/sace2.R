...
add.equation(eq2, "ll", .01, FALSE)
add.equation(eq2, "s", .01, FALSE)
add.equation(eq2, "n")
add(bsm2, eq2)
...
ll<-function(s, l){
  ...
  # create the equation (fix the variance to 1)
  eq2<-equation("eq", 0, TRUE)
  add.equation(eq2, "ll", sqrt(.000019), TRUE)
  add.equation(eq2, "s", l, TRUE)
  add.equation(eq2, "n", sqrt(0.000143), TRUE)
  add.equation(bsm2, eq2)
  rslt2<-estimate(bsm2, log(s), marginal=TRUE)
