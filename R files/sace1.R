...
add(bsm, regtd("td", frequency(s), start(s), length(s), c(1,1,1,1,2,3,0)))
# create the equation 
eq<-equation("eq", .01, F)
add.equation(eq, "ll")
add.equation(eq, "s")
...
add(bsm2, regtd("td", frequency(s), start(s), length(s), c(1,2,3,4,5,6,0)))
# create the equation 
...
add(airline, regtd("td", frequency(s), start(s), length(s), c(1,1,1,1,2,3,0)))
